...
public class SwaggerConfiguration {
    ...
    // CONTACT
    private static final Contact DEFAULT_CONTACT = new Contact("Nogari", "http://www.cspi.co.kr","cspi@cspi.co.kr" );
 
    // API INFO
    private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Nogari RestAPI Project",
            "Cspi SpringBoot Norgari Rest API Service",
            "1.0",
            "urn:tos",
            DEFAULT_CONTACT,
